...
All rights, title and interest in and to the Site and all its Content will remain with and belong exclusively to Bitroot and the company. You will not:
...
You authorise Bitroot and the Company, directly or through third parties, to make any inquiries necessary to validate your identity and confirm your ownership of your email address or financial instruments. Failure to provide information about you and your business when requested is a violation of this Agreement.
...
This Agreement constitutes the final and exclusive T&C between the parties relating to this subject matter and supersedes all terms, whether prior or contemporaneous, written or oral, concerning such subject matter. The T&C is executed in counterparts through digital acceptance.`
  ...
  return (
    <Layout className="min-h-screen bg-gray-100">
      <Header className="bg-white flex items-center justify-between px-8">
        <img src="logo.svg" alt="Bitroot Logo" className="h-8" />
      </Header>
      <Content className="p-8 max-w-4xl mx-auto">
        <Title level={2} className="text-5xl font-bold mb-4 text-center">Terms of Service</Title>
        <div className="bg-white p-8 rounded-lg shadow-md h-[calc(100vh-300px)] overflow-y-auto">
          <Title level={4} className="text-xl font-bold mb-4">BITROOT TERMS</Title>
          <Paragraph className="whitespace-pre-wrap">{termsContent}</Paragraph>
        </div>
      </Content>
