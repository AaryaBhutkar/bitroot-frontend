...
// import TasksSearchFilter from "./pages/TasksSearchFilter";
              ...
              <>
                <div className="w-full mb-4 flex items-center">
                  <Input
                    ...
                    style={{ width: "calc(100% - 100px)", height: "40px" }} // Adjust height as needed
                  />
                  <Button
                    className="p-4"
                    type="primary"
                    onClick={handleSearch}
                    style={{ width: "100px", height: "40px" }} // Adjust width and height as needed
                  >
                    Search
                  </Button>
                </div>
